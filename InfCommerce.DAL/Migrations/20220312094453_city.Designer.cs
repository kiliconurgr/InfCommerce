...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfCommerce.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            LastDate = new DateTime(2022, 3, 12, 12, 44, 53, 91, DateTimeKind.Local).AddTicks(7144),
                            LastIPNo = "1",
            ...
            modelBuilder.Entity("InfCommerce.DAL.Entities.City", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfCommerce.DAL.Entities.Distinct", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InfCommerce.DAL.Entities.Distinct", b =>
                {
                    b.HasOne("InfCommerce.DAL.Entities.City", "City")
                        .WithMany("Distincts")
